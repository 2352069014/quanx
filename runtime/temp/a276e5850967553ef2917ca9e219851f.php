<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"F:\phpstudy\PHPTutorial\WWW\quanx\public/../application/index\view\index\imglist.htm";i:1583201417;s:71:"F:\phpstudy\PHPTutorial\WWW\quanx\application\index\view\public\top.htm";i:1583200575;s:74:"F:\phpstudy\PHPTutorial\WWW\quanx\application\index\view\public\footer.htm";i:1583200679;}*/ ?>
...
<div id="header_wrap">
    ...
    <style type="text/css">
        ...
        #l-nav
        {
            background-image: url('/blog4/index/style/simg/look-bike-nav-bg.png');
            width: 188px;
            height: 360px;
            float: left;
        }
        ...
        #menu-item-198{ background-image:url('/index/images/up-arrow.png'); background-position: center bottom; background-repeat:no-repeat;} 
        .boxBor{
...
<div class="xh_265x265x00">
    <div style="float: left; width: 343px; height: 293px; background-color: #ffffff;
                ...
                <div style="background-color: #cccccc; width: 313px; height: 188px; margin-top: 16px;
                    margin-left: 14px;">
                    <a target="_blank" href="/life/416.html"><img src="/index/images/1-1402061T015922.jpg" alt="COACH再度携手王力宏 踩单车演绎2013秋冬男士纽约风尚" height="188" width="313"></a>
                </div>
                ...
                <div style="background-color: #cccccc; width: 313px; height: 188px; margin-top: 16px;
                    margin-left: 14px;">
                    <a target="_blank" href="/life/392.html"><img src="/index/images/352.jpg" alt="骑看世界：三个女孩的欧洲骑行之路" height="188" width="313"></a>
                </div>
                <div style="margin-left: 14px; line-height: 25px; margin-top: 10px;">
                    <div style="font-size: 12px;color:#cccccc;">2014年02月06日</div>
                    <div style="font-size: 14px;height:45px;">
                ...
                <div style="background-color: #cccccc; width: 313px; height: 188px; margin-top: 16px;
                    margin-left: 14px;">
                    <a target="_blank" href="/life/395.html"><img src="/index/images/355.jpg" alt="骑看世界：探索地中海科西嘉岛" height="188" width="313"></a>
                </div>
                <div style="margin-left: 14px; line-height: 25px; margin-top: 10px;">
                    <div style="font-size: 12px;color:#cccccc;">2014年02月06日</div>
                    <div style="font-size: 14px;height:45px;">
                ...
                <div style="background-color: #cccccc; width: 313px; height: 188px; margin-top: 16px;
                    margin-left: 14px;">
                    <a target="_blank" href="/life/361.html"><img src="/index/images/321.jpg" alt="骑行40000公里 英国胶片摄影师的骑游之旅" height="188" width="313"></a>
                </div>
                <div style="margin-left: 14px; line-height: 25px; margin-top: 10px;">
                    <div style="font-size: 12px;color:#cccccc;">2014年02月06日</div>
                    <div style="font-size: 14px;height:45px;">
                ...
                <div style="background-color: #cccccc; width: 313px; height: 188px; margin-top: 16px;
                    margin-left: 14px;">
                    <a target="_blank" href="/life/394.html"><img src="/index/images/1-1402061F00W33.jpg" alt="骑看世界：春节骑行海南岛 畅游冬日骑行天堂" height="188" width="313"></a>
                </div>
                <div style="margin-left: 14px; line-height: 25px; margin-top: 10px;">
                    <div style="font-size: 12px;color:#cccccc;">2014年02月06日</div>
                    <div style="font-size: 14px;height:45px;">
                ...
                <div style="background-color: #cccccc; width: 313px; height: 188px; margin-top: 16px;
                    margin-left: 14px;">
                    <a target="_blank" href="/life/364.html"><img src="/index/images/324.jpg" alt="隆猫西班牙自行车之旅-Mallorca岛梦幻旅程（上）" height="188" width="313"></a>
                </div>
                <div style="margin-left: 14px; line-height: 25px; margin-top: 10px;">
                    <div style="font-size: 12px;color:#cccccc;">2014年02月06日</div>
                    <div style="font-size: 14px;height:45px;">
                ...
                <div style="background-color: #cccccc; width: 313px; height: 188px; margin-top: 16px;
                    margin-left: 14px;">
                    <a target="_blank" href="/life/393.html"><img src="/index/images/353.jpg" alt="复古骑行上海，听法国大梧桐诉说旧日故事" height="188" width="313"></a>
                </div>
                <div style="margin-left: 14px; line-height: 25px; margin-top: 10px;">
                    <div style="font-size: 12px;color:#cccccc;">2014年02月06日</div>
                    <div style="font-size: 14px;height:45px;">
                ...
                <div style="background-color: #cccccc; width: 313px; height: 188px; margin-top: 16px;
                    margin-left: 14px;">
                    <a target="_blank" href="/life/389.html"><img src="/index/images/347.jpg" alt="执着的小辫与西藏的骑车旅行" height="188" width="313"></a>
                </div>
                <div style="margin-left: 14px; line-height: 25px; margin-top: 10px;">
                    <div style="font-size: 12px;color:#cccccc;">2014年02月06日</div>
                    <div style="font-size: 14px;height:45px;">
                ...
                <div style="background-color: #cccccc; width: 313px; height: 188px; margin-top: 16px;
                    margin-left: 14px;">
                    <a target="_blank" href="/life/390.html"><img src="/index/images/348.jpg" alt="大理洱海骑行 到挖色赶个大集" height="188" width="313"></a>
                </div>
                <div style="margin-left: 14px; line-height: 25px; margin-top: 10px;">
                    <div style="font-size: 12px;color:#cccccc;">2014年02月06日</div>
                    <div style="font-size: 14px;height:45px;">
                ...
                <div style="background-color: #cccccc; width: 313px; height: 188px; margin-top: 16px;
                    margin-left: 14px;">
                    <a target="_blank" href="/life/391.html"><img src="/index/images/350.jpg" alt="KONA 29寸车骑游哥伦比亚" height="188" width="313"></a>
                </div>
                <div style="margin-left: 14px; line-height: 25px; margin-top: 10px;">
                    <div style="font-size: 12px;color:#cccccc;">2014年02月06日</div>
                    <div style="font-size: 14px;height:45px;">
                ...
                <div style="background-color: #cccccc; width: 313px; height: 188px; margin-top: 16px;
                    margin-left: 14px;">
                    <a target="_blank" href="/life/386.html"><img src="/index/images/344.jpg" alt="Cyclist:赵勇权传授台湾环岛骑行摄影经验" height="188" width="313"></a>
                </div>
                <div style="margin-left: 14px; line-height: 25px; margin-top: 10px;">
                    <div style="font-size: 12px;color:#cccccc;">2014年02月06日</div>
                    <div style="font-size: 14px;height:45px;">
                ...
                <div style="background-color: #cccccc; width: 313px; height: 188px; margin-top: 16px;
                    margin-left: 14px;">
                    <a target="_blank" href="/life/387.html"><img src="/index/images/346.jpg" alt="两个青海 骑行在3197米之上" height="188" width="313"></a>
                </div>
                <div style="margin-left: 14px; line-height: 25px; margin-top: 10px;">
                    <div style="font-size: 12px;color:#cccccc;">2014年02月06日</div>
                    <div style="font-size: 14px;height:45px;">
    ...
    <script type="text/javascript">
        ...
        $(".more0").hover(function () { $(this).attr("src", "/index/style/simg/more-o.png"); }, function () { $(this).attr("src", "/index/style/simg/more.png"); });
    </script>
