                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="pid" >
                                    ...
                                    <option value="<?php echo $value['id']; ?>"><?php echo str_repeat('---',$value['level']); ?><?php echo $value['catename']; ?></option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="control-group">
                                    <div class="radio">
                                        <label>
                                            <input name="type" type="radio" class="colored-blue" checked="checked" value="1">
